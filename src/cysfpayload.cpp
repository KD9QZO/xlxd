...
const unsigned char WHITENING_DATA[] = {
	0x93U, 0xD7U, 0x51U, 0x21U,
	0x9CU, 0x2FU, 0x6CU, 0xD0U,
	0xEFU, 0x0FU, 0xF8U, 0x3DU,
	0xF1U, 0x73U, 0x20U, 0x94U,
	0xEDU, 0x1EU, 0x7CU, 0xD8U
};
...
CYSFPayload::CYSFPayload(): m_uplink(NULL), m_downlink(NULL), m_source(NULL), m_dest(NULL) {
}
